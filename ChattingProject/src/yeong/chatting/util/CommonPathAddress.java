...
public class CommonPathAddress {

	// 클라이언트 레이아웃 경로
	public static final String LoginLayout = "/yeong/chatting/client/view/LoginLayout.fxml";
	public static final String RegistryLayout = "/yeong/chatting/client/view/RegistryLayout.fxml";
	public static final String WaitingRoomLayout = "/yeong/chatting/client/view/WaitingRoomLayout.fxml";
	public static final String CreateRoomLayout = "/yeong/chatting/client/view/CreateRoomLayout.fxml";
	public static final String ChattingRoomLayout = "/yeong/chatting/client/view/ChattingRoomLayout.fxml";
